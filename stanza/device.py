...
class Device:
    ...
    def sweep_nd_hardware(
        ...
        Delegates to :func:`hardware_sweep`. Supports 1D and 2D sweeps.

        Args:
            axes: List of SweepAxis definitions (1 or 2 axes).
            measure_electrode: Name of the measurement electrode.
            voltage_source: Instrument implementing ListSweepInstrument (e.g. QDAC).
            controller: Instrument implementing HardwareSweepController (e.g. OPX).
