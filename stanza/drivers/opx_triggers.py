"""OPX-specific trigger configuration.

TriggerConfig and TriggerMode encode QUA clock-cycle timing and QUA digital
port addressing.  They belong here, not in the generic triggers module.
"""
...
class TriggerMode(Enum):
    """Trigger mode for OPX instrument synchronization."""
...
class TriggerConfig:
    """Configuration for an OPX trigger mode.
